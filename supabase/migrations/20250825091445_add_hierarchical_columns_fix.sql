-- Add hierarchical category support - FIX
-- This migration safely adds parent_id and sort_order columns if they don't exist
...
-- Update existing categories with sort_order only if they have default value
